...
The reply was posted the same day — [the comment](https://github.com/Equal-Vote/bettervoting/issues/1480#issuecomment-5363512155), copied verbatim in [1480-comment-posted.md](1480-comment-posted.md): it accepts the convention, withdraws the Scope over-reach, and offers the backend one-liner — reopen or a fresh backend-scoped ticket, maintainer's choice.
